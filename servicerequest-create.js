...
module.exports = function(RED) {
		...
		if(dot4ConfigNode){
			...
			node.on('input', async function(msg) {
				try{
					...
					const createdIncident = await incidentManagementApi.createServiceRequest( msg.payload);
					//{
						  // name: msg.payload.name,
						  // description: msg.payload.description,
						  // category_INC: msg.payload.category						  
					//}
					//);	
    ...
    RED.nodes.registerType("servicerequest-create",ticketCreate);
}